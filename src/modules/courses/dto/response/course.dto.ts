...
import { CourseWithSections, SectionWithTeachersAndTimes } from '@/shared/interfaces';
  ...
  static formatCourseResponse(course: CourseWithSections): CourseResponseDto {
    ...
    return new CourseResponseDto({
      ...
      sections: sections.map(section =>
        SectionResponseDto.formatSectionResponse(section as SectionWithTeachersAndTimes),
      ),
    });
  }
